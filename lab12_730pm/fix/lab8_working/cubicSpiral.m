...
%                     if(a >= 0)
%                         a1Tab.set(poseArray(1,i), poseArray(2,i), a);
%                         b1Tab.set(poseArray(1,i), poseArray(2,i), b);
%                         r1Tab.set(poseArray(1,i), poseArray(2,i), norm(poseArray(1,i), poseArray(2,i)));
%                     end
%                     if(a <= 0)
%                         a2Tab.set(poseArray(1,i), poseArray(2,i), a);
%                         b2Tab.set(poseArray(1,i), poseArray(2,i), b);
%                         r2Tab.set(poseArray(1,i), poseArray(2,i), norm(poseArray(1,i), poseArray(2,i)));
%                     end
       ...
       function setParms(obj,parms)
        ...
        function integrateCommands(obj)
            ...
            for i=1:obj.numSamples-1
                ...
                obj.poseArray(3,i+1) = obj.poseArray(3,i) + obj.curvArray(i+1)*ds;
                th = obj.poseArray(3,i+1);
                obj.poseArray(2,i+1) = obj.poseArray(2,i) + ds*sin(th);
                obj.poseArray(1,i+1) = obj.poseArray(1,i) + ds*cos(th);
            end
            i = obj.numSamples;
            s = (i-1)*ds;  
            obj.distArray(i) = s;
