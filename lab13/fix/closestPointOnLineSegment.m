...
%Given set of points and a line segment, returns the closest point and
%square of distance to segment for each point. If the closest point is an
%endpoint, returns infinity for rad2 because such points are bad for lidar
%matching localization
%
% pi - Array of points of size 2xn
